...
CanonicalBrowsingContext::CreateLoadingSessionHistoryEntryForLoad(
  ...
  if (Navigation::IsAPIEnabled()) {
    ...
    MOZ_LOG(gNavigationLog, LogLevel::Debug,
            ("Determining navigation type from loadType=%u",
             aLoadState->LoadType()));
